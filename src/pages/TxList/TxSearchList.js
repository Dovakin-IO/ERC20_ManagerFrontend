    ...
    columns = [
        {
            ...
            render: (text, record) => (
                <span>
                    ...
                    }}>{text.substring(0,6) + "..." + text.substring(60,66)}</a>
                </span>
            ),
        ...
        },
        {
            ...
            render: (text, record) => (
                <span>
                    <a href="javascript:;">{text.substring(0,6) + "..." + text.substring(36,42)}</a>
                </span>
            ),
        },
        {
        ...
        },
        {
            ...
            render: (text, record) => (
                <span>
                    {text.substring(0,text.length-18)}
                </span>
            ),
