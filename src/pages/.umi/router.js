...
let routes = [
  {
    ...
    component: dynamic({
      ...
      loading: require("/Users/dovakin/Documents/github/ERC20_ManagerFrontend/src/components/PageLoading/index")
        .default
    }),
    routes: [
      {
      ...
      },
      {
        component: () =>
          React.createElement(
            require("/Users/dovakin/Documents/github/ERC20_ManagerFrontend/node_modules/umi-build-dev/lib/plugins/404/NotFound.js")
              .default,
        ...
        routes: [
          {
            ...
            name: "searchtable",
            component: dynamic({
              loader: () => import("../TxList/TxSearchList"),
              loading: require("/Users/dovakin/Documents/github/ERC20_ManagerFrontend/src/components/PageLoading/index")
                .default
            }),
            exact: true
        ...
        routes: [
          {
            ...
            name: "userdetail",
            component: dynamic({
              loader: () => import("../TxUser/TxUserDetail"),
              loading: require("/Users/dovakin/Documents/github/ERC20_ManagerFrontend/src/components/PageLoading/index")
                .default
            }),
            exact: true
